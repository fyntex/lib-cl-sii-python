...
class _Cesion(pydantic.BaseModel):
    ...
    def as_cesion_aec_xml(self) -> data_models_aec.CesionAecXml:
        ...
        return data_models_aec.CesionAecXml(
            ...
            # cedente_persona_autorizada_rut=doc_cesion_struct.cedente.ruts_autorizados[0].rut,
            # cedente_persona_autorizada_nombre=doc_cesion_struct.cedente.ruts_autorizados[0].nombre,
...
# Resolve the forward references of Pydantic model fields that could not be resolved during model
# creation.
#
# Unresolved forward references can also be fixed by reordering model classes, but the resulting
# code would be more difficult to understand.
#
# See also: https://pydantic-docs.helpmanual.io/usage/postponed_annotations/.
_Cedente.update_forward_refs()
_DocumentoCesion.update_forward_refs()
_Cesion.update_forward_refs()
_DteCedido.update_forward_refs()
_DocumentoAec.update_forward_refs()
_Aec.update_forward_refs()
